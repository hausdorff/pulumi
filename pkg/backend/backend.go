...
type Backend interface {
	...
	// ParsePolicyPackReference takes a fully-qualified PolicyPack name (i.e., of the form
	// <orgName/policyPackName>), and parses it to a reference which may be used for other methods
	// in this backend.
	ParsePolicyPackReference(s string) (PolicyPackReference, error)

	// GetPolicyPack returns a PolicyPack object tied to this backend, or nil if it cannot be found.
	GetPolicyPack(ctx context.Context, policyPackRef PolicyPackReference, d diag.Sink) (PolicyPack, error)
