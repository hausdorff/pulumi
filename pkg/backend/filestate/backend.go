...
func (b *localBackend) ParsePolicyPackReference(s string) (backend.PolicyPackReference, error) {
	return nil, fmt.Errorf("File state backend does not support resource policy")
}

func (b *localBackend) GetPolicyPack(ctx context.Context, policyPackRef backend.PolicyPackReference,
